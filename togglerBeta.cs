...
public class toggler : EditorWindow
{
    ...
    public static void ShowWindow() { GetWindow<toggler>("Toggler 3.0.1"); }

    private void OnGUI()
    {
        GUILayout.Label("Version: 3.0.1");
        ...
        switch (toolBar)
        {
            case 0:
                ...
                if (GUILayout.Button("Create Toggle"))
                {
                    ...
                    // FX Menu
                    createFXParameter(controller, objectToggle.name, type);
                    ...
                    // Adding Menu
                    addParameterMenuEntry(objectsList, objectToggle.name, "bool");
                }
            ...
            case 1:
                ...
                if (parameterName != "" && objectsList.Count > 1 && objectsList[1].item != null)
                    if (GUILayout.Button("Create Toggles"))
                    {
                        ...
                        // FX Menu
                        createFXParameter(controller, parameterName, type);
                        ...
                        // Adding Menu
                        addParameterMenuEntry(objectsList, parameterName, "int");
